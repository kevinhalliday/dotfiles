...
set runtimepath^=/Users/kevinhalliday/src/kevinhalliday/vim-go-syntax
...
function! s:packager_init(packager) abort
  ...
  call a:packager.add('git@github.com:nvim-lua/plenary.nvim')
  call a:packager.add('git@github.com:sindrets/diffview.nvim')
  call a:packager.add('git@github.com:nvim-tree/nvim-web-devicons')
  ...
  " FZF:
  call a:packager.add('git@github.com:junegunn/fzf.git', {  'do': { -> fzf#install() } })
  ...
  " call a:packager.add('git@github.com:fatih/vim-go.git')
  call a:packager.add('git@github.com:iden3/vim-circom-syntax.git')
  call a:packager.add('git@github.com:Louis-Amas/noir-vim-support.git')
...
augroup filetype_recognition
  ...
  autocmd BufNewFile,BufRead,BufEnter coc-settings.json  set filetype=jsonc
  autocmd BufNewFile,BufRead,BufEnter .cairo  set filetype=cairo
  autocmd BufNewFile,BufRead,BufEnter .nr  set filetype=noir
  autocmd BufNewFile,BufRead,BufEnter *go.mod  set filetype=gomod
augroup end
...
augroup custom_comment_config
  ...
  autocmd FileType gomod setlocal commentstring=//\ %s comments=://
  autocmd FileType gowork setlocal commentstring=//\ %s comments=://
  autocmd FileType noir setlocal commentstring=//\ %s comments=://
...
augroup indentation_sr
  autocmd!
  autocmd Filetype python,c,haskell,rust,rst,kv,nginx,asm,nasm,gdscript3,cairo,solidity
        \ setlocal shiftwidth=4 softtabstop=4 tabstop=8
  autocmd Filetype dot setlocal autoindent cindent
  autocmd Filetype make,tsv,votl,go,gomod,gowork
        \ setlocal tabstop=4 softtabstop=0 shiftwidth=4 noexpandtab
...
augroup colorcolumn_configuration
  ...
  autocmd FileType solidity setlocal colorcolumn=120 textwidth=120
augroup end
...
function! FzfHomeFiles()
  let l:fzf_preview = 'bat --color always --style plain {2..}'
  let l:fzf_command = 'rg --files --no-ignore --no-messages --hidden --follow --glob "!.git/*" /Users/kevinhalliday/'
  call FzfWithDevIcons(l:fzf_command, l:fzf_preview)
endfunction

function! FzfSrcFiles()
  let l:fzf_preview = 'bat --color always --style plain {2..}'
  let l:fzf_command = 'rg --files --no-ignore --no-messages --hidden --follow --glob "!.git/*" /Users/kevinhalliday/src/'
  call FzfWithDevIcons(l:fzf_command, l:fzf_preview)
endfunction
